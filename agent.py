...
async def add_comment_to_state(ctxt: Context, draft_comment: str) -> str:
    ...
    async with ctxt.store.edit_state () as ctxt_state:
        ...
        ctxt_state["comment"] = comment
        ctxt_state["review_comment"] = draft_comment
...
async def add_final_review_to_state(ctxt: Context, final_review: str) -> str:
    ...
    async with ctxt.store.edit_state () as ctxt_state:
        review = ctxt_state.get ("review", [])
        if not isinstance (review, list):
            review = []
        review.append (final_review)
        ctxt_state["review"] = review
        ctxt_state["final_review"] = final_review
